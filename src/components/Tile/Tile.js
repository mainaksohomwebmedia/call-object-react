...
=======
    ...
    return ( <
        ...
        id = { props.dataid } >
        <
        div className = "background" / > { getDataId() } { getOverlayComponent() } { getVideoComponent() } { getAudioComponent() } { getCornerMessageComponent() } <
        /div>
    );
}
>>>>>>> be2af4051f9f9e556236348b90c34166657ff46a
