...
export default function Tile(props) {
    ...
    function getClassNames() {
        ...
        props.isLocalPerson && (classNames += ' local k__' + props.key);
        return classNames;
    }
    ...
    return ( <
        ...
        <
        div className = "background" / > { getOverlayComponent() } { getVideoComponent() } { getAudioComponent() } { getCornerMessageComponent() } <
        /div>
    );
}